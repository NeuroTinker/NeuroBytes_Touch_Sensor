...
extern volatile uint16_t active_input_pins[2] = {0,0};

extern volatile uint16_t active_output_pins[2] = {PIN_AXON1_EX,PIN_AXON2_EX};
...
void writeAll(void)
{
    ...
    active_output_pins[0] = PIN_AXON1_EX;
    for (i=0;i<2;i++){
